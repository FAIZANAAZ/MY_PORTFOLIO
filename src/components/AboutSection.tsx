...
function AboutSection() {
  return (
    <>
      <section id='about' className='w-full py-[160px] px-10 bg-pink-300 flex flex-col md:flex-row justify-center'>
        
        <div className='mx-auto w-[50%] px-[16px] flex flex-col items-start text-left'>
          <p className={`${caveat.className} text-[48px] text-black`}>FAIZA NAAZ</p>
