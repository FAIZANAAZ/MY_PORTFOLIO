     ...
     <section id="testimonials" className="bg-[#0a0908] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-yellow-400">W</span>hat{' '}
            <span className="text-yellow-400">O</span>ther{' '}
            <span className="text-yellow-400">P</span>eople{' '}
            <span className="text-yellow-400">S</span>ay
          </span>
        </h4>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-[8rem] border-[3px] border-solid border-text-yellow-400 rounded-full p-1">
                  <Image
                    src={person.src}
                    alt={person.alt}
                    width={128}
                ...
                <p className="my-4 text-yellow-400">{person.role}</p>
